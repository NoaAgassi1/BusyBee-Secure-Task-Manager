...
public final class Task implements java.io.Serializable {
    ...
    private UUID addComment(Function<Integer, TaskComment> commentGenerator, Optional<UUID> after) {
        ...
        System.out.println("DEBUG: Adding comment. Parent ID: " + after + ", Parent Index: " + afterIdx);

        int indent = (afterIdx == -1) ? 0 : m_comments.get(afterIdx).indent() + 1;
        System.out.println("DEBUG: Calculated indent: " + indent);
        ...
        System.out.println("DEBUG: Inserting comment at index: " + (afterIdx + 1));
